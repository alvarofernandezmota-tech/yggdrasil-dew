---
tags: [agentes, perplexity, mcp, github, flujo-trabajo]
fecha: 2026-06-14
estado: referencia
ruta-obsidian: agentes/perplexity.md
---
...
- Mover archivos del inbox a sus destinos
...
El objetivo es reemplazar/complementar Perplexity con un LLM local en Madre que:
...
→ Ver `agentes/gemini.md` | `tools/inbox-processor/README.md`
